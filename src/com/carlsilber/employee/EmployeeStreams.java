...
public class EmployeeStreams {
    ...
    public void whenIncrementSalaryForEachEmployee_thenApplyNewSalary() {
        ...
        assertEquals(empList.get(0).getSalary(), 110000);
        assertEquals(empList.get(1).getSalary(), 220000);
        assertEquals(empList.get(2).getSalary(), 330000);
    }
    ...
    public void whenStreamToArray_thenGetArray() {
        ...
        assertArrayEquals(empList.toArray(), employees);
    }
    ...
    public void whenFindMin_thenGetMinElementFromStream() {
        ...
        assertEquals(firstEmp.getId(), Integer.valueOf(1));
    }
    ...
    public void whenFindMax_thenGetMaxElementFromStream() {
        ...
        assertEquals(maxSalEmp.getSalary(), Double.valueOf(300000.0));
    }
    ...
    public void whenFindMaxOnIntStream_thenGetMaxInteger() {
        ...
        assertEquals(latestEmpId, Integer.valueOf(3));
    }
    ...
    public void whenApplySumOnIntStream_thenGetSum() {
        ...
        assertEquals(avgSal, Double.valueOf(200000));
    }
    ...
    public void whenApplyReduceOnStream_thenGetValue() {
        ...
        assertEquals(sumSal, Double.valueOf(600000));
    }
    ...
    public void whenFileToStream_thenGetStream() throws IOException {
        ...
        assertEquals(str.size(), 2); //contains("refer", "level")
    }
